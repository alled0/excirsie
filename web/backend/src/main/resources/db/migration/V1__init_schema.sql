...
CREATE TABLE workout_sessions (
    ...
    reps_aborted     INTEGER      NOT NULL DEFAULT 0,
    reps_rejected    INTEGER      NOT NULL DEFAULT 0,
...
CREATE TABLE rep_logs (
    ...
    form_score          INTEGER      NOT NULL DEFAULT 0,  -- 0–100
    ...
    penalty_rom         INTEGER      NOT NULL DEFAULT 0,
    penalty_tempo       INTEGER      NOT NULL DEFAULT 0,
    penalty_sway_drift  INTEGER      NOT NULL DEFAULT 0,
    penalty_asymmetry   INTEGER      NOT NULL DEFAULT 0,
    penalty_instability INTEGER      NOT NULL DEFAULT 0,
...
CREATE TABLE feedback (
    ...
    user_rep_correction INTEGER,                     -- their count if they said inaccurate
